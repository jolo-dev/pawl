...
Defined in: node\_modules/constructs/lib/construct.d.ts:241
...
> **new Construct**(`scope`, `id`): [`Construct`](/cdk/classes/construct/)

Defined in: node\_modules/constructs/lib/construct.d.ts:275
