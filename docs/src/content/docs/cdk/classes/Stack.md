...
Defined in: packages/cdk/src/stack.ts:5
...
> **new Stack**(`scope`?, `id`?, `props`?): [`Stack`](/cdk/classes/stack/)

Defined in: packages/cdk/src/stack.ts:7
...
`CdkStack.terminationProtection`
...
`CdkStack.exportStringListValue`
...
`CdkStack.reportMissingContextKey`
