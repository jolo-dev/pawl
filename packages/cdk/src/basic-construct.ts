...
export abstract class BasicConstruct extends Construct {
   ...
   */
  private initializePermissions(constructPermissions: ConstructPermission[]): void {
   ...
   */
  public grantPermission(construct: Construct, policyStatement: PolicyStatement): void {
