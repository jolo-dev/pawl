...
export const CodeBuildLogRetentionDaysSchema = z.union([
	z.literal(1),
	z.literal(3),
	z.literal(5),
	z.literal(7),
...
export type CodeBuildLogRetentionDays = z.infer<
...
const retentionDays: Record<CodeBuildLogRetentionDays, RetentionDays> = {
	...
	2192: RetentionDays.SIX_YEARS,
	2557: RetentionDays.SEVEN_YEARS,
	2922: RetentionDays.EIGHT_YEARS,
	3288: RetentionDays.NINE_YEARS,
...
export class CodeBuildProject extends BasicConstruct {
	...
	constructor(scope: Stack, id: string, props: CodeBuildProjectProps) {
		...
		if (props.permissions) {
			this.grantPermissions(props.permissions);
		}
