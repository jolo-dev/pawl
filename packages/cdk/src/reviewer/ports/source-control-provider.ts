...
export interface SourceControlProvider {
  ...
  getDiff(ref: RequestRef, revisions: RevisionRange): Promise<readonly ChangedFile[]>;
  getFile(ref: RequestRef, revision: string, path: string): Promise<string | undefined>;
  listComments(ref: RequestRef, after?: EventWatermark): Promise<readonly ReviewComment[]>;
  postInlineFinding(
    ref: RequestRef,
    finding: Finding,
  ...
  reactToComment(ref: RequestRef, commentId: string, reaction: string): Promise<void>;
