...
export type RevisionEvent = Extract<
	ReviewEvent,
	{ readonly type: "revision-updated" }
>;
export type HumanCommentEvent = Extract<
	ReviewEvent,
	{ readonly type: "human-comment" }
>;
 ...
 */
export function coalesceReviewEvents(
	events: readonly ReviewEvent[],
): CoalescedReviewEvents {
	...
	return {
		...
		requiresProviderSnapshot: ordered.some(
			({ type }) => type !== "human-comment",
		),
	};
}
